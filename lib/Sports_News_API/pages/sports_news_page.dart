...
import 'package:news_api_task/Sports_News_API/sportsapibloc/sports_api_bloc.dart';
...
class _SportsNewsPageState extends State<SportsNewsPage> {
  SportsApiBloc sportsApiBloc = SportsApiBloc();

  @override
  void initState() {
    sportsApiBloc.add(SportsNewsApiData());
    super.initState();
  }
        ...
        body: Center(
          child: SingleChildScrollView(
            child: Column(
                ...
                children: [
                  BlocProvider(
                    create: (context) => sportsApiBloc,
                    child: BlocBuilder<SportsApiBloc, SportsApiState>(
                      builder: (context, state) {
                        if (state is SportsNewsApiLoading) {
                        ...
                        } else if (state is SportsNewsApiLoaded) {
                          return ListView.builder(
                              physics: NeverScrollableScrollPhysics(),
                              shrinkWrap: true,
                              itemCount: state.sportsNewsModel.articles?.length,
                              itemBuilder: (BuildContext context, int index) {
                                final results = state.sportsNewsModel.articles;
