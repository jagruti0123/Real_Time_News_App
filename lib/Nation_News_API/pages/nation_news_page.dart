...
import 'package:news_api_task/Nation_News_API/nationnewsbloc/nation_api_bloc.dart';
...
class NationNewsPage extends StatefulWidget {
  const NationNewsPage({super.key});

  @override
  State<NationNewsPage> createState() => _NationNewsPageState();
}

class _NationNewsPageState extends State<NationNewsPage> {
  NationApiBloc nationApiBloc = NationApiBloc();

  @override
  void initState() {
    nationApiBloc.add(NationApiData());
    super.initState();
  }
          ...
          child: Column(
            children: [
              Container(
                ...
                child: BlocProvider(
                  create: (context) => nationApiBloc,
                  child: BlocBuilder<NationApiBloc, NationApiState>(
                    builder: (context, state) {
                      if (state is NationApiLoading) {
                      ...
                      } else if (state is NationApiLoaded) {
                        return ListView.builder(
                            physics: NeverScrollableScrollPhysics(),
                            shrinkWrap: true,
                            itemCount: state.nationNewsModel.articles?.length,
                            itemBuilder: (BuildContext context, int index) {
                              final results = state.nationNewsModel.articles;
